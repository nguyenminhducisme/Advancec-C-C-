...
void setOption(CarOptions *car, uint8_t optionMask) {
    car->additionalOptions |= optionMask;          // 0000 | 0100 = 0100
}

void unsetOption(CarOptions *car, uint8_t optionMask) {
    car->additionalOptions &= ~optionMask;   // 00000010 & (11111101) = 00000000
}
...
int main() {
    CarOptions myCar;
    configureCar(&myCar, COLOR_WHITE, POWER_200HP, ENGINE_2_0L, 0); 
